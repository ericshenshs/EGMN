...
class WideAndDeep(torch.nn.Module):
    ...
    Deep part: embeds sparse/sequence features and feeds them through an MLP.
    Wide part: adds linear contributions from continuous features (when present).
    Outputs a scalar (sigmoid) prediction.
    """
    # -------------------------------------------------------------------------
