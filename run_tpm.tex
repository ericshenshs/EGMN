...
\title{\texttt{\detokenize{run_tpm.py}} (Q\&A Documentation)}
\author{}
\date{}
\begin{document}
\begin{CJK*}{UTF8}{gbsn}
...
\vspace{1mm}
\VerbatimInput[firstline=1,lastline=50,fontsize=\small]{/workspace/run_tpm.py}
...
\vspace{1mm}
\VerbatimInput[firstline=12,lastline=29,fontsize=\scriptsize]{/workspace/run_tpm.py}
...
\vspace{1mm}
\VerbatimInput[firstline=32,lastline=38,fontsize=\scriptsize]{/workspace/run_tpm.py}
...
\vspace{1mm}
\VerbatimInput[firstline=40,lastline=48,fontsize=\scriptsize]{/workspace/run_tpm.py}
...
\vspace{1mm}
\VerbatimInput[firstline=50,lastline=62,fontsize=\scriptsize]{/workspace/run_tpm.py}
...
\begin{Verbatim}[fontsize=\small]
python run_tpm.py --dataset_name kuairec --dataset_path ./dataset --device cuda:0
...
\VerbatimInput[fontsize=\scriptsize]{/workspace/run_tpm.py}
