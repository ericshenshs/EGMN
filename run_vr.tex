...
\title{\texttt{\detokenize{run_vr.py}} (Q\&A Documentation)}
\author{}
\date{}
\begin{document}
\begin{CJK*}{UTF8}{gbsn}
...
\vspace{1mm}
\VerbatimInput[firstline=1,lastline=50,fontsize=\small]{/workspace/run_vr.py}
...
\vspace{1mm}
\VerbatimInput[firstline=11,lastline=25,fontsize=\scriptsize]{/workspace/run_vr.py}
...
\vspace{1mm}
\VerbatimInput[firstline=27,lastline=33,fontsize=\scriptsize]{/workspace/run_vr.py}
...
\vspace{1mm}
\VerbatimInput[firstline=35,lastline=43,fontsize=\scriptsize]{/workspace/run_vr.py}
...
\vspace{1mm}
\VerbatimInput[firstline=45,lastline=56,fontsize=\scriptsize]{/workspace/run_vr.py}
...
\begin{Verbatim}[fontsize=\small]
python run_vr.py --dataset_name kuairec --dataset_path ./dataset --device cuda:0
...
\VerbatimInput[fontsize=\scriptsize]{/workspace/run_vr.py}
